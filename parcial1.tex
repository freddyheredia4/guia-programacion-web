...
\begin{figure}[H]
	\center
	\includegraphics[width=1\textwidth]{TypeScriptInterfaces.png}
	\caption{Interfases}
\end{figure}

\begin{figure}[H]
	\center
	\includegraphics[width=1\textwidth]{TypeScriptClasses.png}
	\caption{Clases}
\end{figure}

\begin{figure}[H]
	\center
	\includegraphics[width=1\textwidth]{TypeScriptTypes.png}
	\caption{Tipos}
\end{figure}
