...
\begin{figure}[H]
	\center
	\includegraphics[width=0.7\textwidth]{tcp-udp.png}
...
\begin{figure}[H]
	\center
	\includegraphics[width=1\textwidth]{mdn-url-protocol1.png}
	\caption{Protocolo}
\end{figure}
...
\begin{figure}[H]
	\center
	\includegraphics[width=1\textwidth]{mdn-url-domain.png}
	\caption{Dominio}
\end{figure}
