...
\usepackage{hyperref}
\hypersetup{hidelinks,colorlinks=false,breaklinks=true,urlcolor= ocre,bookmarksopen=false,pdftitle=Programación de aplicaciones WEB,pdfauthor=Freddy Heredia}
\usepackage{bookmark}
\bookmarksetup{
open,
numbered,
